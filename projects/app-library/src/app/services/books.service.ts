...
export class BooksService {
  ...
  public selectedBookId: number = 0;
  public allbooks: any = [];
  public patchEnabled: boolean = true;
  public httpOptions = {
  ...
  public updateBookTitle(bookData: any) {
    return this.http.patch(this.apiUrl+"/books/", bookData, this.httpOptions); 
  }
